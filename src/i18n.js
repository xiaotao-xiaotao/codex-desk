...
const TOKEN_USAGE_TRANSLATIONS = {
  "zh-CN": { tokenUsageKicker: "Token洞察", tokenUsageTitle: "Token 使用趋势", tokenUsageRangeLabel: "Token 趋势范围", tokenUsageRange3: "近3天趋势", tokenUsageRange7: "近7天趋势", tokenUsageRange30: "近30天趋势", tokenUsageTotal: "合计：{total} Token", tokenUsageTooltipDate: "日期", tokenUsageTooltipTokens: "Token", tokenUsageTooltipSessions: "会话数", tokenUsageTrendTab: "趋势", tokenUsageDistributionTab: "会话分布", tokenUsageDistributionTitle: "会话 Token 分布", tokenUsageDistributionSummary: "合计：{count} 个会话", tokenUsageDistributionNoData: "近 {days} 天暂无本机会话 Token 数据。", tokenUsageLoading: "正在读取 Token 使用数据…", tokenUsageUnavailable: "Token 使用数据暂时不可用。", tokenUsageNoData: "近 {days} 天暂无可展示的 Token 数据。" },
  "zh-TW": { tokenUsageKicker: "Token 洞察", tokenUsageTitle: "Token 使用趨勢", tokenUsageRangeLabel: "Token 趨勢範圍", tokenUsageRange3: "近3天趨勢", tokenUsageRange7: "近7天趨勢", tokenUsageRange30: "近30天趨勢", tokenUsageTotal: "合計：{total} Token", tokenUsageTooltipDate: "日期", tokenUsageTooltipTokens: "Token", tokenUsageTooltipSessions: "工作階段數", tokenUsageTrendTab: "趨勢", tokenUsageDistributionTab: "工作階段分布", tokenUsageDistributionTitle: "工作階段 Token 分布", tokenUsageDistributionSummary: "合計：{count} 個工作階段", tokenUsageDistributionNoData: "近 {days} 天沒有本機工作階段 Token 資料。", tokenUsageLoading: "正在讀取 Token 使用資料…", tokenUsageUnavailable: "Token 使用資料暫時無法使用。", tokenUsageNoData: "近 {days} 天沒有可顯示的 Token 資料。" },
  ...
  ja: { tokenUsageKicker: "Token インサイト", tokenUsageTitle: "Token 使用量の推移", tokenUsageRangeLabel: "Token の期間", tokenUsageRange3: "過去3日", tokenUsageRange7: "過去7日", tokenUsageRange30: "過去30日", tokenUsageTotal: "合計：{total} Token", tokenUsageTooltipDate: "日付", tokenUsageTooltipTokens: "Token", tokenUsageTooltipSessions: "セッション数", tokenUsageTrendTab: "推移", tokenUsageDistributionTab: "セッション分布", tokenUsageDistributionTitle: "セッション Token 分布", tokenUsageDistributionSummary: "合計：{count} セッション", tokenUsageDistributionNoData: "過去 {days} 日のローカルセッション Token データはありません。", tokenUsageLoading: "Token 使用量を読み込み中…", tokenUsageUnavailable: "Token 使用量を取得できません。", tokenUsageNoData: "過去 {days} 日の Token データはありません。" },
...
const SESSION_ANALYTICS_TRANSLATIONS = {
  "zh-CN": {
    ...
    threadBasicInfo: "会话基础信息", threadTitleLabel: "会话标题", threadCreatedLabel: "创建时间", threadUpdatedLabel: "最后更新", threadIdLabel: "会话 ID", threadModelLabel: "模型版本", threadStatusLabel: "状态", threadStatusCompleted: "已完成", threadStatusInProgress: "进行中", threadStatusFailed: "失败", threadStatusInterrupted: "已中断", threadStatusUnknown: "未提供",
    threadFileChangesRecord: "文件变更记录", threadIssuesRecord: "失败与中断", threadRecordCount: "共 {count} 条", threadNoFileChanges: "暂无文件变更", threadNoIssues: "暂无异常记录", threadViewAllRecords: "查看全部", threadCollapseRecords: "收起", threadTokenUsage: "Token 用量", threadTokenCompact: "{total} Token", threadTokenTotal: "总消耗：{total} Token", threadTokenInputOutput: "输入：{input} ｜输出：{output}", threadTokenCached: "缓存输入：{tokens}", threadTokenReasoning: "推理输出：{tokens}", threadTokenToolsUnavailable: "工具调用：暂无独立统计", threadTokenUnavailable: "当前会话未保存 Token 快照。", threadMessageDuration: "用时 {value}", threadExport: "导出会话", threadCopyId: "复制会话 ID", threadRefresh: "刷新", threadMoreActions: "更多操作",
  },
  "zh-TW": {
    ...
    threadBasicInfo: "工作階段基本資訊", threadTitleLabel: "工作階段標題", threadCreatedLabel: "建立時間", threadUpdatedLabel: "最後更新", threadIdLabel: "工作階段 ID", threadModelLabel: "模型版本", threadStatusLabel: "狀態", threadStatusCompleted: "已完成", threadStatusInProgress: "進行中", threadStatusFailed: "失敗", threadStatusInterrupted: "已中斷", threadStatusUnknown: "未提供",
    threadFileChangesRecord: "檔案變更記錄", threadIssuesRecord: "失敗與中斷", threadRecordCount: "共 {count} 筆", threadNoFileChanges: "暫無檔案變更", threadNoIssues: "暫無異常記錄", threadViewAllRecords: "檢視全部", threadCollapseRecords: "收合", threadTokenUsage: "Token 用量", threadTokenCompact: "{total} Token", threadTokenTotal: "總消耗：{total} Token", threadTokenInputOutput: "輸入：{input} ｜輸出：{output}", threadTokenCached: "快取輸入：{tokens}", threadTokenReasoning: "推理輸出：{tokens}", threadTokenToolsUnavailable: "工具呼叫：暫無獨立統計", threadTokenUnavailable: "目前工作階段未儲存 Token 快照。", threadMessageDuration: "耗時 {value}", threadExport: "匯出工作階段", threadCopyId: "複製工作階段 ID", threadRefresh: "重新整理", threadMoreActions: "更多操作",
  },
  en: {
    ...
    threadBasicInfo: "SESSION INFO", threadTitleLabel: "Title", threadCreatedLabel: "Created", threadUpdatedLabel: "Updated", threadIdLabel: "Session ID", threadModelLabel: "Model", threadStatusLabel: "Status", threadStatusCompleted: "Completed", threadStatusInProgress: "In progress", threadStatusFailed: "Failed", threadStatusInterrupted: "Interrupted", threadStatusUnknown: "Unavailable",
    threadFileChangesRecord: "FILE CHANGES", threadIssuesRecord: "FAILURES & INTERRUPTIONS", threadRecordCount: "{count} total", threadNoFileChanges: "No file changes", threadNoIssues: "No issues", threadViewAllRecords: "View all", threadCollapseRecords: "Collapse", threadTokenUsage: "TOKEN USAGE", threadTokenCompact: "{total} tokens", threadTokenTotal: "Total: {total} tokens", threadTokenInputOutput: "Input: {input} | Output: {output}", threadTokenCached: "Cached input: {tokens}", threadTokenReasoning: "Reasoning output: {tokens}", threadTokenToolsUnavailable: "Tool calls: no separate usage", threadTokenUnavailable: "No Token snapshot is saved for this session.", threadMessageDuration: "Took {value}", threadExport: "Export", threadCopyId: "Copy session ID", threadRefresh: "Refresh", threadMoreActions: "More actions",
  },
  ja: {
    ...
    threadBasicInfo: "セッション基本情報", threadTitleLabel: "タイトル", threadCreatedLabel: "作成日時", threadUpdatedLabel: "最終更新", threadIdLabel: "セッション ID", threadModelLabel: "モデル", threadStatusLabel: "状態", threadStatusCompleted: "完了", threadStatusInProgress: "進行中", threadStatusFailed: "失敗", threadStatusInterrupted: "中断", threadStatusUnknown: "未提供",
  ...
  ko: {
    ...
    threadBasicInfo: "세션 기본 정보", threadTitleLabel: "세션 제목", threadCreatedLabel: "생성 시간", threadUpdatedLabel: "마지막 업데이트", threadIdLabel: "세션 ID", threadModelLabel: "모델", threadStatusLabel: "상태", threadStatusCompleted: "완료", threadStatusInProgress: "진행 중", threadStatusFailed: "실패", threadStatusInterrupted: "중단됨", threadStatusUnknown: "제공되지 않음",
    threadFileChangesRecord: "파일 변경 기록", threadIssuesRecord: "실패 및 중단", threadRecordCount: "총 {count}개", threadNoFileChanges: "파일 변경 없음", threadNoIssues: "예외 없음", threadViewAllRecords: "모두 보기", threadCollapseRecords: "접기", threadTokenUsage: "Token 사용량", threadTokenCompact: "{total} Token", threadTokenTotal: "합계: {total} Token", threadTokenInputOutput: "입력: {input} ｜출력: {output}", threadTokenCached: "캐시 입력: {tokens}", threadTokenReasoning: "추론 출력: {tokens}", threadTokenToolsUnavailable: "도구 호출: 별도 집계 없음", threadTokenUnavailable: "이 세션에 Token 스냅샷이 없습니다.", threadMessageDuration: "소요 시간 {value}", threadExport: "내보내기", threadCopyId: "세션 ID 복사", threadRefresh: "새로고침", threadMoreActions: "추가 작업",
  },
};
...
const QUOTA_LABEL_TRANSLATIONS = {
  "zh-CN": { compactQuotaWindowDays: "{count} 天", compactQuotaWindowHours: "{count} 小时", usedPercent: "已使用 {used}%", resetTime: "下次重置时间：{value}", resetCountdown: "下次重置：{value}", resetCreditsLabel: "可用重置额度", quotaWarning: "额度偏低", quotaCritical: "额度不足", unknown: "未知" },
  "zh-TW": { compactQuotaWindowDays: "{count} 天", compactQuotaWindowHours: "{count} 小時", usedPercent: "已使用 {used}%", resetTime: "下次重設時間：{value}", resetCountdown: "下次重設：{value}", resetCreditsLabel: "可用重設額度", quotaWarning: "額度偏低", quotaCritical: "額度不足", unknown: "未知" },
  en: { compactQuotaWindowDays: "{count}d", compactQuotaWindowHours: "{count}h", usedPercent: "{used}% used", resetTime: "Next reset: {value}", resetCountdown: "Next reset: {value}", resetCreditsLabel: "Reset credits", quotaWarning: "Low quota", quotaCritical: "Quota exhausted", unknown: "Unknown" },
  ja: { compactQuotaWindowDays: "{count}日", compactQuotaWindowHours: "{count}時間", resetCredits: "リセットクレジット：{credits}", usedPercent: "使用済み {used}%", resetTime: "次回リセット：{value}", resetCountdown: "次回リセット：{value}", resetCreditsLabel: "リセットクレジット", quotaWarning: "残りわずか", quotaCritical: "クォータ不足", unknown: "不明" },
  ko: { compactQuotaWindowDays: "{count}일", compactQuotaWindowHours: "{count}시간", usedPercent: "{used}% 사용", resetTime: "다음 재설정: {value}", resetCountdown: "다음 재설정: {value}", resetCreditsLabel: "재설정 크레딧", quotaWarning: "할당량 부족", quotaCritical: "할당량 소진", unknown: "알 수 없음" },
};
