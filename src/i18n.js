...
const TOKEN_USAGE_TRANSLATIONS = {
  "zh-CN": { tokenUsageKicker: "Token洞察", tokenUsageTitle: "Token 使用趋势", tokenUsageRangeLabel: "Token 趋势范围", tokenUsageRange3: "近3天趋势", tokenUsageRange7: "近7天趋势", tokenUsageRange30: "近30天趋势", tokenUsageTotal: "合计：{total} Token", tokenUsageTooltipDate: "日期", tokenUsageTooltipTokens: "Token", tokenUsageTooltipSessions: "会话数", tokenUsageTrendTab: "趋势", tokenUsageDistributionTab: "会话分布", tokenUsageDistributionTitle: "会话 Token 分布", tokenUsageDistributionSummary: "本机 {count} 个会话", tokenUsageDistributionNoData: "近 {days} 天暂无本机会话 Token 数据。", tokenUsageLoading: "正在读取 Token 使用数据…", tokenUsageUnavailable: "Token 使用数据暂时不可用。", tokenUsageNoData: "近 {days} 天暂无可展示的 Token 数据。" },
  "zh-TW": { tokenUsageKicker: "Token 洞察", tokenUsageTitle: "Token 使用趨勢", tokenUsageRangeLabel: "Token 趨勢範圍", tokenUsageRange3: "近3天趨勢", tokenUsageRange7: "近7天趨勢", tokenUsageRange30: "近30天趨勢", tokenUsageTotal: "合計：{total} Token", tokenUsageTooltipDate: "日期", tokenUsageTooltipTokens: "Token", tokenUsageTooltipSessions: "工作階段數", tokenUsageTrendTab: "趨勢", tokenUsageDistributionTab: "工作階段分布", tokenUsageDistributionTitle: "工作階段 Token 分布", tokenUsageDistributionSummary: "本機 {count} 個工作階段", tokenUsageDistributionNoData: "近 {days} 天沒有本機工作階段 Token 資料。", tokenUsageLoading: "正在讀取 Token 使用資料…", tokenUsageUnavailable: "Token 使用資料暫時無法使用。", tokenUsageNoData: "近 {days} 天沒有可顯示的 Token 資料。" },
  en: { tokenUsageKicker: "TOKEN INSIGHTS", tokenUsageTitle: "Token usage trend", tokenUsageRangeLabel: "Token range", tokenUsageRange3: "Last 3 days", tokenUsageRange7: "Last 7 days", tokenUsageRange30: "Last 30 days", tokenUsageTotal: "Total: {total} tokens", tokenUsageTooltipDate: "Date", tokenUsageTooltipTokens: "Tokens", tokenUsageTooltipSessions: "Sessions", tokenUsageTrendTab: "Trend", tokenUsageDistributionTab: "Sessions", tokenUsageDistributionTitle: "Session Token distribution", tokenUsageDistributionSummary: "{count} local sessions", tokenUsageDistributionNoData: "No local session Token data for the last {days} days.", tokenUsageLoading: "Reading token usage…", tokenUsageUnavailable: "Token usage is unavailable.", tokenUsageNoData: "No token data for the last {days} days." },
  ja: { tokenUsageKicker: "Token インサイト", tokenUsageTitle: "Token 使用量の推移", tokenUsageRangeLabel: "Token の期間", tokenUsageRange3: "過去3日", tokenUsageRange7: "過去7日", tokenUsageRange30: "過去30日", tokenUsageTotal: "合計：{total} Token", tokenUsageTooltipDate: "日付", tokenUsageTooltipTokens: "Token", tokenUsageTooltipSessions: "セッション数", tokenUsageTrendTab: "推移", tokenUsageDistributionTab: "セッション分布", tokenUsageDistributionTitle: "セッション Token 分布", tokenUsageDistributionSummary: "ローカル {count} セッション", tokenUsageDistributionNoData: "過去 {days} 日のローカルセッション Token データはありません。", tokenUsageLoading: "Token 使用量を読み込み中…", tokenUsageUnavailable: "Token 使用量を取得できません。", tokenUsageNoData: "過去 {days} 日の Token データはありません。" },
  ko: { tokenUsageKicker: "Token 인사이트", tokenUsageTitle: "Token 사용량 추세", tokenUsageRangeLabel: "Token 기간", tokenUsageRange3: "최근 3일", tokenUsageRange7: "최근 7일", tokenUsageRange30: "최근 30일", tokenUsageTotal: "합계: {total} Token", tokenUsageTooltipDate: "날짜", tokenUsageTooltipTokens: "Token", tokenUsageTooltipSessions: "세션 수", tokenUsageTrendTab: "추세", tokenUsageDistributionTab: "세션 분포", tokenUsageDistributionTitle: "세션 Token 분포", tokenUsageDistributionSummary: "로컬 세션 {count}개", tokenUsageDistributionNoData: "최근 {days}일의 로컬 세션 Token 데이터가 없습니다.", tokenUsageLoading: "Token 사용량을 읽는 중…", tokenUsageUnavailable: "Token 사용량을 사용할 수 없습니다.", tokenUsageNoData: "최근 {days}일의 Token 데이터가 없습니다." },
};
